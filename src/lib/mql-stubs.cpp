...
BOOL WINAPI Recorder_GetSymbolDefinitionA(int i, const char* symbol, const char* description, const char* group, int digits, const char* hstDirectory, int hstFormat) {
   return(FALSE);
   #pragma EXPANDER_EXPORT
}
