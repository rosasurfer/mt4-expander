 ...
 * 21:07:44.053  SyncMainContext_init(298)    084F44E0  TestExpert  UR_UNDEFINED   ec={pid=1, previousPid=0, programType=PT_EXPERT, programName="TestExpert", programCoreFunction=CF_INIT, programInitReason=IR_USER, programUninitReason=UR_UNDEFINED, programInitFlags=0, programDeinitFlags=0, moduleType=MT_EXPERT, moduleName="TestExpert", moduleCoreFunction=CF_INIT, moduleUninitReason=UR_UNDEFINED, moduleInitFlags=0, moduleDeinitFlags=0, symbol="GBPUSD", timeframe=PERIOD_M15, digits=5, point=1e-005, rates=NULL, bars=0, changedBars=-1, unchangedBars=-1, ticks=0, cycleTicks=0, currTickTime=0, prevTickTime=0, bid=0, ask=0, superContext=NULL, threadId=3880 (non-UI), hChart=0x00090DC2, hChartWindow=0x000B0DDE, test=0x099583C0, testing=TRUE, visualMode=TRUE, optimization=FALSE, extReporting=FALSE, recorder=FALSE, mqlError=0, dllError=0, dllWarning=0, logEnabled=TRUE, logFilename=""} (0x084F44E0)
 * 21:07:44.116  SyncLibContext_init(534)     084F48C8  rsfLib1     UR_UNDEFINED   ec={} (0x084F48C8)
 * 21:07:44.116  SyncLibContext_init(764)     084F48C8  rsfLib1     UR_UNDEFINED   ec={pid=1, previousPid=0, programType=PT_EXPERT, programName="TestExpert", programCoreFunction=CF_INIT, programInitReason=IR_USER, programUninitReason=UR_UNDEFINED, programInitFlags=0, programDeinitFlags=0, moduleType=MT_LIBRARY, moduleName="rsfLib1", moduleCoreFunction=CF_INIT, moduleUninitReason=UR_UNDEFINED, moduleInitFlags=0, moduleDeinitFlags=0, symbol="GBPUSD", timeframe=PERIOD_M15, digits=5, point=1e-005, rates=NULL, bars=0, changedBars=-1, unchangedBars=-1, ticks=0, cycleTicks=0, currTickTime=0, prevTickTime=0, bid=0, ask=0, superContext=NULL, threadId=3880 (non-UI), hChart=0x00090DC2, hChartWindow=0x000B0DDE, test=0x099583C0, testing=TRUE, visualMode=TRUE, optimization=FALSE, extReporting=FALSE, recorder=FALSE, mqlError=0, dllError=0, dllWarning=0, logEnabled=TRUE, logFilename=""} (0x084F48C8)
 ...
 * 21:08:05.347  SyncMainContext_init(298)    084F4CB0  TestExpert  UR_UNDEFINED   ec={pid=3, previousPid=1, programType=PT_EXPERT, programName="TestExpert", programCoreFunction=CF_INIT, programInitReason=IR_USER, programUninitReason=UR_UNDEFINED, programInitFlags=0, programDeinitFlags=0, moduleType=MT_EXPERT, moduleName="TestExpert", moduleCoreFunction=CF_INIT, moduleUninitReason=UR_UNDEFINED, moduleInitFlags=0, moduleDeinitFlags=0, symbol="GBPUSD", timeframe=PERIOD_M15, digits=5, point=1e-005, rates=NULL, bars=0, changedBars=-1, unchangedBars=-1, ticks=0, cycleTicks=0, currTickTime=0, prevTickTime=0, bid=0, ask=0, superContext=NULL, threadId=3184 (non-UI), hChart=0x000D0DE2, hChartWindow=0x00080D8C, test=0x0995F938, testing=TRUE, visualMode=TRUE, optimization=FALSE, extReporting=FALSE, recorder=FALSE, mqlError=0, dllError=0, dllWarning=0, logEnabled=TRUE, logFilename=""} (0x084F4CB0)
 ...
 * 07:30:03.888  SyncMainContext_init(213)    0733A448  TestExpert  UR_UNDEFINED   ec={pid=1, previousPid=0, programType=PT_EXPERT, programName="TestExpert", programCoreFunction=CF_INIT, programInitReason=IR_USER, programUninitReason=UR_UNDEFINED, programInitFlags=0, programDeinitFlags=0, moduleType=MT_EXPERT, moduleName="TestExpert", moduleCoreFunction=CF_INIT, moduleUninitReason=UR_UNDEFINED, moduleInitFlags=0, moduleDeinitFlags=0, symbol="GBPUSD", timeframe=PERIOD_M15, digits=5, point=1e-005, rates=NULL, bars=0, changedBars=-1, unchangedBars=-1, ticks=0, cycleTicks=0, currTickTime=0, prevTickTime=0, bid=0, ask=0, superContext=NULL, threadId=1564 (non-UI), hChart=NULL, hChartWindow=NULL, test=0x08E6E940, testing=TRUE, visualMode=FALSE, optimization=FALSE, extReporting=FALSE, recorder=FALSE, mqlError=0, dllError=0, dllWarning=0, logEnabled=TRUE, logFilename=""} (0x0733A448)
 * 07:30:03.951  SyncLibContext_init(446)     07210248  rsfLib1     UR_UNDEFINED   ec={} (0x07210248)
 * 07:30:03.951  SyncLibContext_init(673)     07210248  rsfLib1     UR_UNDEFINED   ec={pid=1, previousPid=0, programType=PT_EXPERT, programName="TestExpert", programCoreFunction=CF_INIT, programInitReason=IR_USER, programUninitReason=UR_UNDEFINED, programInitFlags=0, programDeinitFlags=0, moduleType=MT_LIBRARY, moduleName="rsfLib1", moduleCoreFunction=CF_INIT, moduleUninitReason=UR_UNDEFINED, moduleInitFlags=0, moduleDeinitFlags=0, symbol="GBPUSD", timeframe=PERIOD_M15, digits=5, point=1e-005, rates=NULL, bars=0, changedBars=-1, unchangedBars=-1, ticks=0, cycleTicks=0, currTickTime=0, prevTickTime=0, bid=0, ask=0, superContext=NULL, threadId=1564 (non-UI), hChart=NULL, hChartWindow=NULL, test=0x08E6E940, testing=TRUE, visualMode=FALSE, optimization=FALSE, extReporting=FALSE, recorder=FALSE, mqlError=0, dllError=0, dllWarning=0, logEnabled=TRUE, logFilename=""} (0x07210248)
 ...
 * 07:30:06.328  SyncMainContext_init(213)    07210C88  TestExpert  UR_UNDEFINED   ec={pid=3, previousPid=1, programType=PT_EXPERT, programName="TestExpert", programCoreFunction=CF_INIT, programInitReason=IR_USER, programUninitReason=UR_UNDEFINED, programInitFlags=0, programDeinitFlags=0, moduleType=MT_EXPERT, moduleName="TestExpert", moduleCoreFunction=CF_INIT, moduleUninitReason=UR_UNDEFINED, moduleInitFlags=0, moduleDeinitFlags=0, symbol="GBPUSD", timeframe=PERIOD_M15, digits=5, point=1e-005, rates=NULL, bars=0, changedBars=-1, unchangedBars=-1, ticks=0, cycleTicks=0, currTickTime=0, prevTickTime=0, bid=0, ask=0, superContext=NULL, threadId=2352 (non-UI), hChart=NULL, hChartWindow=NULL, test=0x08EDD9D8, testing=TRUE, visualMode=FALSE, optimization=FALSE, extReporting=FALSE, recorder=FALSE, mqlError=0, dllError=0, dllWarning=0, logEnabled=TRUE, logFilename=""} (0x07210C88)
 ...
 * @param  BOOL               isRecording         - an expert's input parameter "EA.Recorder"
 ...
 */
int WINAPI SyncMainContext_init(EXECUTION_CONTEXT* ec, ProgramType programType, const char* programName, UninitializeReason uninitReason, DWORD initFlags, DWORD deinitFlags, const char* symbol, uint timeframe, uint digits, double point, BOOL isRecording, BOOL isTesting, BOOL isVisualMode, BOOL isOptimization, BOOL isExternalReporting, EXECUTION_CONTEXT* sec, HWND hChart, int droppedOnChart, int droppedOnPosX, int droppedOnPosY) {
   ...
   ec_SetRecording           (ec, isRecording);
