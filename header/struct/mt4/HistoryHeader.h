...
struct HISTORY_HEADER {                            // -- offset ---- size --- description ----------------------------------------------------------------------------
   ...
   time32 syncMarker;                              //        88         4     data server synchronization marker, updated by the terminal on Chart->Refresh
   time32 lastSyncTime;                            //        92         4     unused (not overwritten by the terminal)
...
time32      WINAPI hh_SetSyncMarker   (HISTORY_HEADER* hh, time32      timestamp  );
time32      WINAPI hh_SetLastSyncTime (HISTORY_HEADER* hh, time32      timestamp  );
...
time32      WINAPI hhs_SetSyncMarker  (HISTORY_HEADER hhs[], int index, time32      timestamp  );
time32      WINAPI hhs_SetLastSyncTime(HISTORY_HEADER hhs[], int index, time32      timestamp  );
